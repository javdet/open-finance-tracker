				...
				<form onSubmit={handleSubmit} className="px-6 py-4 space-y-4">
					...
					<div ref={categoryDropdownRef} className="relative">
						...
						<button
							...
							className="block w-full rounded border border-strong bg-surface-card text-primary px-2 py-1.5 text-sm shadow-sm text-left focus:outline-none focus:ring-1 focus:ring-rose-500 focus:border-rose-500 flex items-center justify-between gap-2"
							...
							>
								<li className="px-2 pb-1">
									<input
										...
										className="w-full rounded border border-strong bg-surface-card text-primary px-2 py-1 text-xs shadow-sm focus:outline-none focus:ring-1 focus:ring-rose-500 focus:border-rose-500"
									/>
								</li>
								{categories
									.filter((cat) => {
									...
									.map((cat) => (
										<li
											...
											className={`cursor-pointer px-2 py-1.5 text-sm hover:bg-surface-hover ${categoryId === cat.id ? 'bg-rose-50 text-rose-800' : 'text-secondary'} ${cat.parentCategoryId ? 'pl-4 font-normal' : 'font-semibold'}`}
											onClick={() => {
					...
					<div>
						...
						<input
							...
							placeholder="0.00"
							className="block w-full rounded border border-strong bg-surface-card text-primary px-2 py-1.5 text-sm shadow-sm focus:outline-none focus:ring-1 focus:ring-rose-500 focus:border-rose-500"
						/>
					</div>

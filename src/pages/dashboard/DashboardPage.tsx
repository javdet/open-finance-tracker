	...
	return (
		<div className="space-y-6">
			<div className="flex flex-wrap items-center justify-between gap-4">
				...
				<div className="relative" ref={monthDropdownRef}>
					<button
						...
						className="inline-flex items-center gap-2 rounded-lg border border-strong bg-surface-card px-3 py-2 text-sm font-medium text-secondary hover:bg-surface-hover transition-colors shadow-sm"
			...
			<section aria-labelledby="balance-history-heading">
				...
				{showBalanceHistory && (
					<div className="mt-3 rounded-lg border bg-surface-card p-4 shadow-sm">
						<BalanceHistoryChart />
					</div>
				)}
			</section>
			...
			<section aria-labelledby="plan-vs-actual-heading">
				...
				{planVsActualError && (
					<div className="rounded-md bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-800 px-4 py-3 mb-3">
						<p className="text-sm text-red-600 dark:text-red-400">{planVsActualError}</p>
					</div>
				)}
				{planVsActualLoading ? (
					<div
						className="flex items-center justify-center text-muted text-sm rounded-lg border bg-surface-card py-12"
						style={{ minHeight: 220 }}
					>
